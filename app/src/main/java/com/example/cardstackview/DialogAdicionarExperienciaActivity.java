...
public class DialogAdicionarExperienciaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_adicionar_experiencia_layout);
        ...
        ExperienciaAdapter adapterExp = new ExperienciaAdapter(listaExperiencias);
        ...
        btnAddExp.setOnClickListener(v -> {
